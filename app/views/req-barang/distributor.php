                            ...
                            <tbody>
                                ...
                                <?php foreach ($data['req_barang'] as $barang) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= BASEURL ?>/requestBarang/terima/<?= $barang['id_req_barang']; ?>" class="btn btn-success <?= $barang['is_accepted'] == 1 ? 'disabled' : '' ?>">Terima</a>
                                            <a href="<?= BASEURL ?>/requestBarang/tolak/<?= $barang['id_req_barang']; ?>" class="btn btn-danger <?= $barang['is_accepted'] == 1 ? 'disabled' : '' ?>">Tolak</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>

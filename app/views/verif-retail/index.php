<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Verifikasi Retail</h1>
        </div>
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4>Daftar Verifikasi Retail</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($data['retail'] as $barang) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- button ktp -->
                                            <a target="_blank" href="<?= BASEURL ?>/ktp/<?= $barang['ktp']; ?>" class="btn btn-primary <?= $barang['is_verified'] == 1 ? 'disabled' : '' ?>">KTP</a>
                                            <!-- button siu -->
                                            <a target="_blank" href="<?= BASEURL ?>/siu/<?= $barang['siu']; ?>" class="btn btn-primary <?= $barang['is_verified'] == 1 ? 'disabled' : '' ?>">SIU</a>
                                        </td>
                                        <td>
                                            <?php if ($barang['is_verified'] == 0) : ?>
                                                <span class="badge badge-warning">Belum Diterima</span>
                                            <?php elseif ($barang['is_verified'] == 1) : ?>
                                        ...
                                        <td>
                                            <a href="<?= BASEURL ?>/verifikasiRetail/terima/<?= $barang['id_retail']; ?>" class="btn btn-success <?= $barang['is_verified'] == 1 ? 'disabled' : '' ?>">Terima</a>
                                            <a href="<?= BASEURL ?>/verifikasiRetail/tolak/<?= $barang['id_retail']; ?>" class="btn btn-danger <?= $barang['is_verified'] == 1 ? 'disabled' : '' ?>">Tolak</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
